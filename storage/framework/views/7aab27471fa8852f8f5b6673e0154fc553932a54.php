    ...
    <div class="row">
        <div class="col-md-10">
            <form method="post" action="">
                ...
                <input type="text" style="display:none"  value="<?php echo e($order->id); ?>" placeholder="<?php echo e($order); ?>" name="order">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\absolutelychef_complete_errors\absolutelychef_1.14.3\absolutelychef\resources\views/admin/post-new-job.blade.php ENDPATH**/ ?>