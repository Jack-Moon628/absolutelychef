            ...
            <div class="col-md-8">
                ...
                <div class="employer-job-listing mt-4">
                    ...
                    @if($jobs->count())
                        ...
                        @foreach($jobs as $job)
                            <div class="employer-job-listing-single {{$job->is_premium? ' premium-job ' : '' }}  bordered shadow-sm rounded-lg mb-3 ">
                                ...
                                <div class="listing-job-info">
                                    <div class="p-2">
                                        ...
                                        <div class="h5 text-primary m-0">
                                            <p class="m-0">
                                                ...
                                                {{ $job->city_name  .', '. $job->state_name . ', ' .   $job->country_name}}
                                            </p>       
                                        </div>
                                        <p class="m-0">
                                            @if($job->is_premium)
                                    ...
                                    <div class="p-2">
                                        <p class="text-muted mb-1 mt-1">
                                            ...
                                            <i class="la la-calendar-times-o"></i> @lang('app.deadline') : {{$job->deadline->format(get_option('date_format'))}} 

                                        </p>
                                        
                                        <p class=" mb-1">
                                            {{ limit_words($job->description)  }}
                                        </p>
                                    </div>
