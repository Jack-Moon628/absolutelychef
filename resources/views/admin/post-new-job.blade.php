        ...
        <div class="col-md-10">
            <form method="post" action="">
                ...
                <div class="form-group row {{ $errors->has('deadline')? 'has-error':'' }}">
                    ...
                    <div class="col-sm-8">
                        <input type="text" data-provide="datepicker" data-date-format="dd-mm-yyyy" class="form-control {{e_form_invalid_class('deadline', $errors)}} date_picker" id="deadline" value="{{ old('deadline')}}" name="deadline" placeholder="dd-mm-yyyy">
